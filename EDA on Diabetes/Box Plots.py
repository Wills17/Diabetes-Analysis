...
sns.boxplot(data=diabetes, x=x ,y="Pregnancies", hue=x)
...
sns.set_style("darkgrid")
sns.boxplot(data= diabetes, x=x, y="Glucose", hue=x)
...
sns.set_style("darkgrid")
sns.boxplot(data=diabetes, x=x, y="BloodPressure", hue=x)
...
sns.set_style("darkgrid")
sns.boxplot(data=diabetes, x=x, y="SkinThickness", hue=x)
...
sns.set_style("darkgrid")
sns.boxplot(data=diabetes, hue=x, x=x, y="Insulin")
...
sns.set_style("darkgrid")
sns.boxplot(hue=x, data=diabetes, x=x, y="BMI")
plt.legend(loc="center")
...
sns.set_style("darkgrid")
sns.boxplot(data=diabetes, hue=x, x=x, y="DiabetesPedigreeFunction")
...
sns.set_style("darkgrid")
sns.boxplot(data=diabetes, hue=x, x=x, y="Age")
